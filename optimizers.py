...
def get_optimizer(args):
	...
	if args.algorithm == 'rmsprop':
		...
		# optimizer = opt.Adam(lr=0.0005)
		optimizer = opt.Adam(lr=args.learning_rate, beta_1=0.9, beta_2=0.999, epsilon=1e-08, clipnorm=clipnorm, clipvalue=clipvalue)#init 0.0001
